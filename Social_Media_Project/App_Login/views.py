...
def sign_up(request):
    ...
    return render (request, 'App_Login/signup.html', context = {'title':'Sign up . PictureTalks', 'form':form})
def login_page(request):
    ...
    return render(request, 'App_Login/login.html', context = {'title':'Login . PictureTalks','form':form})
@login_required
def edit_profile(request):
    ...
    return render(request,'App_Login/profile.html',context={'form':form, 'title':'Edit Profile . PictureTalks'})
@login_required
...
def follow(request, username):
    following_user = User.objects.get(username=username) #jake follow korte jachhi
    follower_user = request.user #amake jara follow korte chay
